                ...
                ZStack(alignment: .topTrailing) {
                    ...
                    VStack(alignment: .trailing, spacing: 0) {
                        NavigationLink(
                            destination: {
                                AddWordlistPage(
                                    languagePack: modelData.setting.appSettings.languagePackage
                                )
                        ...
                        column2(
                            text: "Sort By",
                            sortTypes: ["Date Edited", "Date Created", "Title"],
                            sortDirections: [["Newest First", "Oldest First"], ["Newest First", "Oldest First"], ["A to Z", "Z to A"]],
        ...
        VStack(spacing: 0) {
            ...
            if showColumn2 {
                ...
                VStack(spacing: 0) {
                    ...
                    LinearGradient(
                        gradient: CustomColor.gradient(from: "efeff3", to: "ededf1"),
                        startPoint: .leading,
                        endPoint: .trailing
                    )
                    .frame(height: 10)
